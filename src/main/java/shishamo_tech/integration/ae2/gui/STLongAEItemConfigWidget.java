...
/**
 * An item config widget that allows configuring slot amounts up to
 * {@link Long#MAX_VALUE}.
 */
public class STLongAEItemConfigWidget extends AEItemConfigWidget {

    public STLongAEItemConfigWidget(int x, int y, ExportOnlyAEItemList list) {
        super(x, y, list);
